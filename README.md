...
│   ├── reward_functions.py       # V5.1吞吐驱动奖励函数
...
│   ├── C_后端验收与REST测试指南.md # ★ 后端与正式模型复验步骤
│   ├── 轻量化验证报告_20260820.md # ★ ONNX/INT8/剪枝产物与验收结论
│   ├── Unity前端部署启动使用说明.md
...
├── models/edge/                  # 轻量化ONNX/TorchScript/INT8/剪枝模型
└── requirements.txt
`
...
# REST与正式模型验收见 docs/C_后端验收与REST测试指南.md
# 轻量化结果见 docs/轻量化验证报告_20260820.md
`
